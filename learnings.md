...
## Dia 1-6/set · #42/#83/#84/#53 — LIÇÃO 10 REGISTADA (E UM CONTRAPONTO IMPORTANTE)
- **#42 "Ricos não vendem":** IG 4.902 + TT 14.333 = 19.235 — 80,7% de todas as views da semana (sozinho). Partilha IG 1,10%, retenção 32,6%
- **#84 banqueiro (3.º ep. série):** TT só 728 — contra 7-16k dos #67/#68. IG 2.277, retenção 40,2% (melhor da semana)
- **#83 (50/30/20):** o mais fraco da semana em quase tudo — IG 445, TT 311, partilha 0,74%
- **#53 (pensões, 65s):** IG 602, TT 237 — mas partilha 3,25% (melhor da semana), retenção 19,4% (pior)
- **LIÇÃO 10 — os três êxitos do canal (#67, #68, #42) partilham uma estrutura mais fina do que "tema-EU" ou "fofoca": um único contraste BINÁRIO, gritante, entre duas coisas já conhecidas (deputado vs. eurodeputado; CEO nacional vs. global; 0% vs. 28%) — nunca uma lista de 3+ partes, nunca um conceito a aprender de raiz.** Isto explica o #83 (receita de 3 partes, não confronto A-vs-B) e o #53 (5-6 números a competir entre si, nenhum vira *o* choque).
- **Contraponto que TEM de ficar registado: o #84 tinha a MESMA estrutura A-vs-B dos três êxitos, e mesmo assim falhou no TT.** A estrutura certa não chega sozinha — hipóteses por ordenar: (a) fadiga da série ao 3º episódio consecutivo, (b) "banqueiro" tem menos fofoca/mistério embutido que "deputado"/"CEO". Sem dados para escolher ainda.
- **Teste proposto, ainda por escrever:** o `#44` ("trabalho paga 48%, capital paga 28%") é estruturalmente gémeo do #42 (mesmo tipo de choque binário, tema fiscal, SEM série a desgastar-se). Se performar como o #42 → confirma que é a estrutura, não sorte do #42. Se falhar → há um 3º ingrediente ainda por isolar.
